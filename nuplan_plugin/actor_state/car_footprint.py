...
from nuplan_plugin.actor_state.oriented_box import OrientedBox, OrientedBoxPointType
...
from nuplan_plugin.geometry.transform import translate_longitudinally
