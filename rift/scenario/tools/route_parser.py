...
from rift.scenario.tools.scenario_configuration import ScenarioConfiguration, ActorConfigurationData
...
class RouteParser(object):
    ...
    @staticmethod
    def parse_routes_file(route_filename, routes_subset='') -> List[RouteScenarioConfiguration]:
        """
