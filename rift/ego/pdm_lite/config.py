...
class GlobalConfig:
    ...
    def __init__(self):
        ...
        # -----------------------------------------------------------------------------
        #  Time step for the model (10 frames per second).
        self.time_step = 1. / 10.
        ...
        # Dataloader
        # -----------------------------------------------------------------------------
        self.carla_fps = 10  # Simulator Frames per second
        ...
        # Agent file
        # -----------------------------------------------------------------------------
        self.carla_frame_rate = 1.0 / 10.0  # CARLA frame rate in milliseconds
